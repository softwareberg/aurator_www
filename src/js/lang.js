...
const arrLang = {
  pl: {
    ...
    'collaborate-title': 'Zapraszamy <br class="d-inline d-xl-none">do współpracy',
    'collaborate-p': 'Wybierz jedną z dostępnych opcji kontaktowych lub zadzwoń, umów się na spotkanie i odwiedź nasze biuro w Gliwicach.<br>Nasz dział handlowy jest do Twojej dyspozycji od poniedizałku do piątku, między 09:00 a 17:00.',
    'collaborate-form': 'Wypełnij formularz kontaktowy',
    'collaborate-or': 'lub',
    'collaborate-phone': 'Zostaw dane kontaktowe - oddzwonimy!',
    'map-spzoo': 'Sp. z o. o.',
